...
from relgraph_util import create_relation_graph, generate_relation_graph,get_relation_triplets
...
parser.add_argument('--seed', type=int, default=42,
                    help='random seed')
parser.add_argument('--train_history_len', type=int, default=5,
...
# # 绘制散点图，其中每个散点表示一个非零元素的位置和值
# plt.scatter(nonzero_indices[1], nonzero_indices[0], c=A[nonzero_indices],marker='o',s=10, cmap='viridis')
#
# # 添加颜色条
# plt.colorbar()
# # plt.title('TRSG of ACLED_2023',loc='')
#
# # 设置坐标轴范围
